...
public class WheatNCrop extends CropBlock {
    ...
    public WheatNCrop() {
        super(AbstractBlock.Settings.of(Material.PLANT).nonOpaque().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP));
    }

    public ItemConvertible getSeedsItem() {
        return NegativeNItems.WHEAT_N_SEED;
    }
