...
public class NegativeNItemGroups {
    ...
    public static final ItemGroup FOOD = createItemGroup(MODID, "food", new ItemStack(NegativeNItems.BREAD_N));

    //public static final ItemGroup POTIONS = createItemGroup(MODID, "potions", new ItemStack(NegativeNItems.DIAMOND_N));
