package net.killarexe.negative_n.client;
...
public class NegativeNClient implements ClientModInitializer {

    Logger logger = LogManager.getLogger();

    @Override
    public void onInitializeClient() {
        logger.info("Negative-N Client Initialize...");
        setupFluidRendering(NegativeNFluids.STILL_WATER_N, NegativeNFluids.FLOWING_WATER_N, new Identifier("minecraft", "lava"), 0x4CC248);
        BlockRenderLayerInit();
        logger.info("Negative-N Client Initialized!");
    }
